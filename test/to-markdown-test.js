...
test('anchors', function() {
  runTestCases([
    ...
    ['<a href="http://example.com/about"> </a>', '', 'a without text']
  ]);
});
...
test('custom converters', function() {
  ...
  equal(toMarkdown(html, {
    converters: [converter]
  }), md, 'Custom filter string');
